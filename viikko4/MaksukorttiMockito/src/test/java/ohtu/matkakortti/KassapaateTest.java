...
public class KassapaateTest {
    ...
    @Test
    public void kortinLataaminenLisaaRahaaJosSummaOnPositiivinen() {
        when(kortti.getSaldo()).thenReturn(3);
    ...
    @Test
    public void kortinLataaminenEiLisaaRahaaJosSummaOnNegatiivinen() {
        when(kortti.getSaldo()).thenReturn(3);
        kassa.lataa(kortti, -5);
