...
public class IntJoukkoTest {
    ...
    public void samaLukuMeneeJoukkoonVaanKerran() {
        joukko.lisaa(10);
        joukko.lisaa(3);
        assertEquals(2, joukko.getKoko());
    }

    @Test
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.onkoJoukossa(10));
        assertFalse(joukko.onkoJoukossa(5));
        assertFalse(joukko.onkoJoukossa(0));
        assertTrue(joukko.onkoJoukossa(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.onkoJoukossa(3));
        assertEquals(1, joukko.getKoko());
    }
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertEquals(14, joukko.getKoko());
        assertTrue(joukko.onkoJoukossa(11));
        joukko.poista(11);
        assertFalse(joukko.onkoJoukossa(11));
        assertEquals(13, joukko.getKoko());
    }
